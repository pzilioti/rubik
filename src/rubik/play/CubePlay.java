...
public class CubePlay {
	...
	public static void main(String[] args) {
		...
		//cube.randomCube("GRYBRBORWOYRRBWRWROYBGWBYWGBYGOOOBWOGOWBWGRGBWOYYYGGRY");

		cube.randomCube("YYOOGWGOWWWOWWBBRRGGWWYRRGGYOYYOBRYOBGRBOOWGBBRRYGRBBY");
		...
		String solution = solver.solve(cube, 7);
